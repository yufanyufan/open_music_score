with ScorePartwise(version='3.1'):
    ...
    with Identification():
        ...
        Source('http://musescore.com/user/4887176/scores/6208745')
    with Defaults():
        with Scaling():
            Millimeters(5.456)
            Tenths(40.0)
    ...
    with Credit(page=1):
        ...
        CreditWords(None)
    with Credit(page=1):
        CreditWords('Französische Suite', default_x=770.015, default_y=2043.6, justify='center', valign='top', font_size='14')
    with Credit(page=1):
        CreditType('composer')

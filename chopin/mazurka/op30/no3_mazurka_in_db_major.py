with ScorePartwise(version='3.1'):
    ...
    with Identification():
        ...
        Source('http://musescore.com/user/33605534/scores/6203251')
    with Defaults():
        with Scaling():
            Millimeters(7.05556)
            Tenths(40.0)
    ...
    with Credit(page=1):
        CreditType('title')
        CreditWords('Mazurka in D♭ Major', default_x=595.44, default_y=1626.67, justify='center', valign='top', font_size='24')
    with Credit(page=1):
        CreditType('composer')
    ...
    with Part(id='P1'):
        ...
        with Measure(number='77', width=220.44):
            ...
            with Direction(placement='below'):
                with DirectionType():
                    Words('più rit. e dim.', font_family='FreeSerif', font_size='12', font_style='italic', default_y=-80.79)
                with DirectionType():
